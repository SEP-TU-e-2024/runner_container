...
## Start Files
To start the Judge Runner including the protocol, use `runner.py`. For development purposes, you can also run this stand-alone with `container.py`. Do make sure that you run a webserver in `local_testing` at the same time.
